              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  ...
                  <a
                    ...
                    className="text-lg sm:text-2xl md:text-3xl font-semibold text-white hover:text-cyan-400 transition-colors break-all"
                  >
                    jnvreddy.dev@gmail.com
                  </a>
                </div>

                {/* Social Icons - Only visible on mobile/tablet (below md) */}
                <div className="flex flex-row items-center justify-center gap-6 md:hidden mt-6">
                  <a
