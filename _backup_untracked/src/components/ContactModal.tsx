...
const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose }) => {
  ...
  const validateForm = (): boolean => {
    ...
    else if (formData.body.trim().length < 10) newErrors.body = 'Message must be at least 10 characters';
    setErrors(newErrors);
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="relative w-[90%] max-w-2xl max-h-[90vh] bg-gray-800/95 backdrop-blur-md border border-gray-600 rounded-2xl shadow-2xl overflow-y-auto flex flex-col"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="flex justify-end items-center p-3 sm:p-4 flex-shrink-0">
            <button
              onClick={onClose}
